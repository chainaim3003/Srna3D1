...
# ============================================================
# CELL 13: Train ADV1 on pdb_xyz_data.pkl (~1-2 hours)
# ============================================================
print("\n" + "="*60)
...
print(f"  Loaded {len(train_data)} structures")

# Filter to sequences <= MAX_SEQ_LEN
train_items = []
...
print(f"  After filtering (<= {MAX_SEQ_LEN} nt): {len(train_items)} structures")
