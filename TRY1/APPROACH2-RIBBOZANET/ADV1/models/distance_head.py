...
NOTE: This file is IDENTICAL to BASIC/models/distance_head.py.
The pair_dim parameter controls input dimension — no hardcoding.
In BASIC: pair_dim=64 (pairwise only).
In ADV1:  pair_dim=64+template_dim (pairwise + template features).
The change is in config.yaml and train.py, not here.
"""
